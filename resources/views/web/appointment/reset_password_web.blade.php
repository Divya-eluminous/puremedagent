...
<div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">@lang('admin.TITLE_RESET_PASSWORD_HEADING')</p>
        <form id='resetPasswordForm'  action="{{ url('/online-appointment/reset-password-web/'.$token) }}" data-toggle="validator">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="form-group">
                    <div class="input-group mb-1 input-group mb-3" id="show_hide_password">
                ...
                <div class="form-group">
                    <div class="input-group mb-1 input-group mb-3" id="show_hide_password_confirm">
                ...
                <input type="hidden" name="hid_patient_id" value="{{$patient_id}}">
