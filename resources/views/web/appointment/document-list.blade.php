...
<div class="container">
  <form id="frmExamination" method="post" data-toggle="validator" action="{{url('/online-appointment/generate-Document-listPdf')}}">
    {{ csrf_field() }}
...
<script type="text/javascript" src="{{asset('assets/web/js/document-list.js')}}"></script> 
<script>
var slideIndex = 1;
