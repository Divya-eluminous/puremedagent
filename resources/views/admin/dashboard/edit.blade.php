      ...
      <div class="col-sm-6">
         <div class="form-group">
            ...
            <select 
               ...
               class="form-control select2" 
               onchange ="getDoctorTimeFramesEdit()" 
               >
      ...
      <div class="col-sm-6">
         <div class="form-group">
           ...
           <!--  <input 
             ...
             <!--new code added swapnil 13-09-2022-->
          <!--  <input 
              type="text" 
              name="date"
              class="form-control"
      ...
      <!-- <div class="col-sm-6">
         <div class="form-group">
            ...
            <select 
               ...
               class="form-control active_status" 
               data-placeholder="@lang('admin.TITLE_SELECT_TEXT') @lang('admin.TITLE_ROSTER_TIME_FRAME')"
               onchange="assignValueToTextEdit()" 
               style="width: 100%;"
               >
...
//End Appointment new updated code by swapnil pawar 13-09-2022
   ...
   $(".active_status").hide();
    ...
    $('#appointment_dateedit').datepicker({
     ...
     // format: 'yyyy-mm-dd',  //swapnil commented on 10-jan-23
      ...
      autoclose: true,
      todayHighlight: true,
     // startDate: new Date() //Commented on 10-jan-23 to show past dates for emergency doctor
     });
});
...
function getDoctorTimeFramesEdit() {
    ...
    {
        var a_id = '';
        var hd_edit_appointment_id1 = $("#hd_edit_appointment_id").val();//added on 13-feb-26
        // GetServices(appointment_type_id,patient_id,a_id,edit_appointment_id);//commented on 13-feb-26
        GetServices(appointment_type_id,patient_id,hd_edit_appointment_id1); //added on 13-feb-26 for edit service
    }
    ...
    if (doctor_id != "" && appointment_type_id != "" && appointment_date != "") {
      ...
      });//Roshani changes the class for larage loader 
      ...
      axios.post(action, {
        ...
        .then(response => {
          $('.appointment-loader_edit').LoadingOverlay("hide");//Roshani changes the class for larage loader 
          ...
          if (doctor_status == 1) {
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      if (response.count == 1) {
                          ...
                          //get doctor time frame
                          // alert(response.hidedate);
                          // alert(response.hideenddate);

                          //Start Below lines added by divya to solve datepicker date not set issue on 19 sept 22
                          ...
                          $('#appointment_from_date_edit').datepicker({
                              //format: 'yyyy-mm-dd', // on 10-jan-23
                               format: 'dd-mm-yyyy', //swapnil added on 10-jan-23
                              orientation: "bottom",
                              autoclose: true,
                              todayHighlight: true,
                             // minDate: response.hidedate     // commented by divya on 19 sep 22
                             // minDate: response.calender_date1  // added by divya on 19 sep 22 commented on 10-jan-23
                          ...
                          $('#appointment_to_date_edit').datepicker({
                             // format: 'yyyy-mm-dd', // on 10-jan-23
                              ...
                              //minDate: response.calender_date2  // added by divya on 19 sep 22 commented on 10-jan-23
              ...
              $('#appointment_dateedit').datepicker({
                 // format: 'yyyy-mm-dd', // on 10-jan-23
                  ...
                  autoclose: true,
                  todayHighlight: true,
                 //startDate: new Date(), //commented on 10-jan-23 for showing past dates for emergency doctor
             ...
             type: "POST",
              ...
              success: function(response) {
                  ...
                  if (response.count == 1) {
                     ...
                     //Start code added by divya added on 19 sept 22
                      //Start Below lines added by divya to solve datepicker date not set issue on 19 sept 22
                      $("#appointment_from_date_edit" ).datepicker( "destroy" );
                      $("#appointment_to_date_edit" ).datepicker( "destroy" );
                      //End Below lines added by divya to solve datepicker date not set issue on 19 sept 22
                      ...
                      $('#appointment_to_date_edit').datepicker({
                          //format: 'yyyy-mm-dd', //commetned on 10-jan-23
                           format: 'dd-mm-yyyy', //swapnil added on 10-jan-23
                          orientation: "bottom",
                          autoclose: true,
                          todayHighlight: true,
                     ...
                     //End code added by divya added on 19 sept 22
           ...
           success: function(response) {
               ...
               if (response.count == 1) {
                  ...
                  //get doctor time frame
                   ...
                   //Code added by swapnil on 10-jan-23
                    $("#appointment_from_date_edit" ).datepicker( "destroy" );
                      $("#appointment_to_date_edit" ).datepicker( "destroy" );
                      //End Below lines added by divya to solve datepicker date not set issue on 19 sept 22
                      ...
                      $('#appointment_from_date_edit').datepicker({
                          ...
                          //minDate: response.calender_date1  // commented by swapnil on 10-jan-23
                           startDate: response.calender_date1,  // Added by swapnil on 10-jan-23
                           minDate:0// Added by swapnil on 15-nov-22
                     ...
                     //End code added by swapnil added on 10-jan-23
