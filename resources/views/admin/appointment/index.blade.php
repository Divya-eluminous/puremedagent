                ...
                <table id="listingTable" class="table table-bordered table-striped" style="width:100%" >
                    <thead class="">
                        <tr>
                            ...
                            <th class="w-140-px">@lang('admin.TITLE_APPOINTMENT_START_DATE')</th>
                            <th class="w-140-px">@lang('admin.TITLE_APPOINTMENT_END_DATE')</th>
                            <th class="w-140-px">@lang('admin.TITLE_APPOINTMENT_PATIENT')</th>
                            <th class="w-200-px">@lang('admin.TITLE_STATUS_APPOINTMENT')</th>
                            <th class="w-200-px">@lang('admin.TITLE_APPOINTMENT_DOCTOR')</th>
                            <th class="w-200-px">
                            @lang('admin.TITLE_APPOINTMENT_TYPE')</th>
...
@section('scripts') 
    <script type="text/javascript" src="{{ asset('/assets/admin/js/appointment/index.js') }}"></script>
