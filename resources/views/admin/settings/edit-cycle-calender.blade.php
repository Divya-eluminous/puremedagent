        ...
        <div class="col-md-12">  
            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <!-- Roshani Added this back button 325 - b - 9 april-2025 -->
                </div>


              
                 <form id="CycleCalenderForm" role="form" data-toggle="validator" action="{{ url('/')}}/admin/settings/updateCycleCalender/{{ base64_encode(base64_encode($setting->id)) }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                             <label class="theme-blue"> 
                                    @lang('admin.TITLE_CYCLE_CALENDER') <span class="required">*</span>
                             </label>
...
<script type="text/javascript" src="{{ url('assets/admin/js/settings/cycle-calender-create-edit.js') }}"></script>
<!-- <script>
