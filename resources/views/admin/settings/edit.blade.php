        ...
        <div class="col-md-12"> 
            ...
            <div class="card card-primary">
                ...
                <form id="settingForm" role="form" data-toggle="validator" action="{{ route($modulePath.'update', [base64_encode(base64_encode($setting->id))]) }}">
                    <input type="hidden" name="hd_setting_key" id="hd_setting_key" value="{{ $setting->setting_key }}" class="form-control">
                            ...
                            <div class="col-sm-12"> 
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        class="form-control" 
                                        @if($setting->setting_key != 'ORDINATION_EMAIL_ADDRESS' && $setting->setting_key != 'EMERGENCY_BUTTON_EMAIL_ADDRESS')
                                            required
                                        @endif
                                        @if($setting->setting_key =='IS_UPDATED')
                                        readonly
                                        @endif
