...
// dd('test',config('constants.API_VERSION_ONE'));
// In routes/api.php
// Route::prefix('v2')
...
Route::group(['prefix' => 'v1','middleware' => ['ApiCustomKeyToken']], function()use($PREFIX) {
...
Route::group(['prefix' => 'v1','middleware' => ['jwt.verify']], function()use($PREFIX) {
