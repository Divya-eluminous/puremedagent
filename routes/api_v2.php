...
Route::group(['prefix' => 'v2','middleware' => ['ApiCustomKeyToken']], function()use($PREFIX) {
    ...
    Route::post('update_password', $PREFIX.'\AuthController@updatePassword');
    Route::post('update_password_puremed', $PREFIX.'\AuthController@updatePasswordPuremed');
    Route::post('update_password_ordination', $PREFIX.'\AuthController@updatePasswordPuremedOrdination');
    Route::post('change_password', $PREFIX.'\AuthController@changePassword'); 
    Route::post('change_password_puremed', $PREFIX.'\AuthController@changePasswordPuremed'); 
    Route::post('resend-otp', $PREFIX.'\AuthController@resendOtp');
...
Route::group(['prefix' => 'v2'], function()use($PREFIX) 
{
...
Route::group(['prefix' => 'v2','middleware' => ['jwt.verify']], function()use($PREFIX) {
