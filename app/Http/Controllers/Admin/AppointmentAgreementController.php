                                ...
                                if(!empty($l_date))
                                {
                                    ...
                                    /*$str .= '<div style="width: 100%;"> 
                                      <div  style="background-color: '.$getSpecilistDocument['background_color'].'">';
                                          if(isset($getSpecilistDocument['header_image_path']))
                                          {
                                            $str .='<img style="width: 100%;height: 100px;" src="'.url('storage'.$getSpecilistDocument['header_image_path']).'" >';
                                          }
                                          ...
                                          if(isset($getSpecilistDocument['footer_image_path']))
                                          {
                                            $str .='<img style="width: 100%;height: 70px;" src="'.url('storage'.$getSpecilistDocument['footer_image_path']).'" >';
                                          }
                                      $str .='</div>
                                      <div>
                            ...
                            if(!empty($getExamDocument) && sizeof($getExamDocument)>0)
                            {
                                foreach ($getExamDocument as $examdoc_key => $examdoc_val) 
                                {
                                    ...
                                    if(!empty($getSpecilistDocument))   
                                    {
                                        ...
                                        $footer_path = self::getFilePath($getSpecilistDocument['header_image_path']);
                                        // dump($header_path);
                                        // dd($footer_path);
                                        if(!empty($l_date))
                                        {
                        ...
                        foreach ($getGeneralDocument as $generalDoc_key => $generalDoc_val) 
                        {
                            ...
                            if(!empty($getSpecilistDocument))
                            {
                                ...
                                if(!empty($l_date))
                                {
                                    ...
                                    $footer_path_gen = self::getFilePath($getSpecilistDocument['header_image_path']);
                                    //dump($header_path_gen);
                        ...
                        foreach ($getGeneralDocument as $generalDoc_key => $generalDoc_val) 
                        {
                            ...
                            if(!empty($getSpecilistDocument))
                            {
                                ...
                                if(!empty($l_date))
                                {
                                    ...
                                    //commented below code on 13oct22
                                   /* $str .= '<div style="width: 100%;"> 
                                      <div  style="background-color: '.$getSpecilistDocument['background_color'].'">';
                                      if(isset($header_path_gen))
                                      {
                                      ...
                                      if(isset($header_path_gen))
                                      {
                                        $str .= '<img style="width: 100%;height: 70px;" src="'.$header_path_gen.'" >';
                                      }
                                      $str .= '</div>
                                      <div>
                                        <p>Herzlichen Dank fur lhre Unterstutzung</p>
