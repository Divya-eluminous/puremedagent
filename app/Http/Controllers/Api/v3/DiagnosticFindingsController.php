...
{ 
                ...
                if($collection->save())
                {
                    ...
                    { 
                        ...
                        foreach($request->file('file') as $file)
                        {
                            ...
                            if(!empty(Config('ordination_id')) && isset($getDatabaseName))
                            {
                                $croppath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/'.$getDatabaseName->uuid.'/diagnostic_findings/crop/'.$fileName;
                            }else{
                                $croppath = '/opt/app-shared/php/data/storage/app/public/diagnostic_findings/crop/'.$fileName;
                            }
                           ...
                           //commented below code on 12-aug-25 
                           // $croppath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/9b15a68114c94800aa29355b4d3c9944/diagnostic_findings/crop/'.$fileName; 
                             ...
                             if(!empty(Config('ordination_id')) && isset($getDatabaseName))
                            {
                                ...
                                $getSizepath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/'.$getDatabaseName->uuid.'/diagnostic_findings/'.$fileName;
                            }
                            else
                            {
                                $getSizepath = '/opt/app-shared/php/data/storage/app/public/diagnostic_findings/'.$fileName;
                            }

                            /************12-aug-25********************************/

                           //commented on 12-aug-25 
                           // $getSizepath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/9b15a68114c94800aa29355b4d3c9944/diagnostic_findings/'.$fileName; 
                             ...
                             if(!empty(Config('ordination_id')) && isset($getDatabaseName))
                            {
                                ...
                                $PdfPath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/'.$getDatabaseName->uuid.'/diagnostic_findings/'.$fileName;
                            }
                            else
                            {
                                $PdfPath = '/opt/app-shared/php/data/storage/app/public/diagnostic_findings/'.$fileName;
                            }
    ...
    public function createDiagnosticFindingsQrcode(Request $request)
    {
                ...
                if($collection->save())
                {
                    ...
                    { 
                        ...
                        foreach($request->file('file') as $file)
                        {
                            ...
                            // $croppath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/9b15a68114c94800aa29355b4d3c9944/diagnostic_findings/crop/'.$fileName;  //commented on 12-aug-24
                            ...
                            // $getSizepath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/9b15a68114c94800aa29355b4d3c9944/diagnostic_findings/'.$fileName;  //commented on 12-aug-24

                            Log::info("getSizepath===>");
                            Log::info($getSizepath);
                            ...
                            // $PdfPath = '/opt/app-shared/php/data/storage/app/public/tenancy/tenants/9b15a68114c94800aa29355b4d3c9944/diagnostic_findings/'.$fileName;//commented on 12-aug-24
        ...
        return self::_sendResult($message,$data,$errors,$status);
    }//createDiagnosticFindingsQrcode


     //added below api on 13-aug-24 for testing on live
    public function createDiagnosticFindingsQrcodeTesting(Request $request)
    {
        ...
        return self::_sendResult($message,$data,$errors,$status);
    }//createDiagnosticFindingsQrcodeTesting  
        ...
        try
        {
            ...
            }else
            {
                ...
                if($admin_email)
                {
                    ...
                    if(isset($admin_email) && !empty($AdminEmail))
