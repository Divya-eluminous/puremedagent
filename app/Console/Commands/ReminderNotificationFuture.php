...
class ReminderNotificationFuture extends Command
{
    /**
    ...
    // protected $signature = 'remindernewfuture:daily {--website_id=}';
    
    // Stancl Tenancy signature
    protected $signature = 'remindernewfuture:daily {--tenant_id=}';
    ...
    public function handle()
    {
        ...
        // log::info("website_id=in handle function=of ReminderNotificationFuture=====>");
        // log::info($website_id);
        // try
        // {
        ...
        //log::info("tenant_id=in handle function=of ReminderNotificationFuture=====>");
       // log::info($tenant_id);
    ...
    //public function _commandOperation($website_id)     
    {
        ...
        //log::info("In ReminderNotificationFuture _commandOperation function ..........");
        ...
        //start code for ordination name and url (updated for Stancl Tenancy)
        ...
        //end code added for ordination name and url (updated for Stancl Tenancy)
        ...
        if(!empty($is_reminder_execute))
        {
           ...
           $collections =  DB::connection('tenant')->table('patient_has_service_reminder')
                        ...
                        ->where('patient_has_service_reminder.created_at','>',date('Y-m-d') . ' 09:40:00')

                        ->where('patient_has_service_reminder.reminder_status','Set')
                        
                         //->where('patients.id',47292) //live commented by vijay 4/4/2024
