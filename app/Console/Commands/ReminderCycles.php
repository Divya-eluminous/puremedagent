...
class ReminderCycles extends Command
{
    /**
    ...
    protected $signature = 'remindercycle:daily {--tenant_id=}';
...
// public function handle()
{
    ...
    log::info("In ReminderCycles _commandOperation function ..........");
   ...
   // log::info(date('Y-m-d'));
    ...
    if(!empty($is_reminder_execute)) 
    {
       ...
       //added on 17-sept-25 // take only pending records who does not have any cycle
      ...
      //  log::info($currentDate);
        ...
        {
            Log::info("in remindercycle not empty collection");
            ...
            foreach ($collections as $key => $value)
            {
             ...
             Log::info("in remindercycle  empty collection");
