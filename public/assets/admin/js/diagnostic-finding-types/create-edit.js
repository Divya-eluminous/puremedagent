...
$('#diagnosticFindingTypeForm').validator().on('submit', function (e) 
{
    // e.preventDefault();
...
function validateColor() {
    ...
    if(val != ''){
        var color = /^#[0-9A-F]{6}$/i.test(val);
        // console.log(color); return;
        if(color == false){
            // console.log('testif'); return;
            $('#validateColor').html("Please enter the valid hex code.");
            $('#validateColor').css('color','red');
